<%-- 
    Document   : Insrt_Atdnc
    Created on : May 9, 2017, 11:41:34 PM
    Author     : ABC
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Student Insert Attendance</title>
                    ...
                    <div class="box">
                        <div>
                            <div id="news" class="body">
                                ...
                                <div id = "stud_profile">
                                    <center><h1><strong>Student Attendance Inserted</strong></h1></center>
                                    <%
