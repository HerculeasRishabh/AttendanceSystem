<!-- THIS IS A DISPLAY PAGE THAT WILL GIVE THE ORDERED NUMERIC VALUE OF 
ATTENDANCE FOR THE WHOLE BATCH -->
...
<html>
	...
	<body>
		<h1 align = "center">Ordered Numeric Batch Attendance</h1>
		<table align = "center" cellspacing = "10" border = "1">
			...
			<%
				...
				ResultSet RS = obj.studNumeric_allSubj_ordrd(batch, dateInitial, dateEnd);
