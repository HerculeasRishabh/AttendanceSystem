...
<html>
	...
	<body>
		...
		if (exportToExcel != null 
		    ...
		    response.setHeader("Content-Disposition", "inline;filename=excel.txt");
		...
		%>
			    ...
			    <a href = "http://localhost:8080/Minor_Project/DisplayBatchExport_Excell.jsp?batch=<%= batch %>&dateInitial=<%= dateInitial%>&dateEnd=<%= dateEnd%>&exportToExcel=YES">Export To Excel</a>
